...
export const revalidate = 86400; //1 dzien renderowanie zawartości w cashu
	...
	return (
		<div className='grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center'>
			...
			<div className='col-span-2'>
				<Image src={about1} placeholder='blur' quality={80} alt='Family sitting around a fire pit in front of cabin' />
			</div>
